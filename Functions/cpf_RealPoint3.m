...
function [chi,chi2, W_prime,generated_points] = cpf_RealPoint3(num_part, chi_prev, qq, gamma, estimated_cp,link,is_initialized,Meshes,triangles,generated_points,point,iteration,Niterations)
    Sigma = eye(7)*1;
