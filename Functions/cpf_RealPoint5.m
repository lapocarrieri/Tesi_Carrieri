...
function [chi,chi2,chi3, W_prime,generated_points,Festimated] = cpf_RealPoint5(num_part, chi_prev,  gamma, estimated_cp,link,is_initialized,Meshes,triangles,generated_points,point,iteration,Niterations,J_w)
    Sigma = eye(7)*1;
    Festimated=1;
