...
function [chi,chi2,chi3, W_prime,generated_points,Festimated] = cpf_RealPoint4(num_part, chi_prev,  gamma, estimated_cp,link,is_initialized,Meshes,triangles,generated_points,point,iteration,Niterations,J_w)
    Festimated=1;
Sigma = eye(7)*1;
